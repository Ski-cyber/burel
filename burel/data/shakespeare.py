...
#
# Dataset semplice di partenza: TinyShakespeare, char-level.
# Nessun tokenizer esterno: il vocabolario sono i caratteri unici del testo.
# Produce train.bin / val.bin (uint16) + meta.pkl (stoi/itos) in data_cache/.
